...
<body class="w-screen flex justify-center h-screen">
    ...
    <div class="w-full flex justify-center items-center ">
        <div class="bg-white shadow-md border w-96 border-gray-200 rounded-lg max-w-sm p-4 sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
            <form class="space-y-6" action="../../backend/php/proses_tambah_pelanggan.php" method="POST">
                <h3 class="text-xl font-medium text-gray-900 dark:text-white">Sign in to our platform</h3>
                <div>
                    <label for="email" class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Your Name</label>
                    <input type="text" name="nama" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="name@company.com" required="">
                </div>
                <div>
                ...
                <div>
                    <label for="password" class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Your Phone Number</label>
                    <input type="tel" name="telp" id="tel" placeholder="+62xxxxx" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required="">
                </div>
                <div>
                ...
                <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                    Already have an account? <a href="./login.php" class="text-blue-700 hover:underline dark:text-blue-500">Log In</a>
                </div>
            </form>
        </div>
    </div>
